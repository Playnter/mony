var drawerMessages = [
  ...
  { id: 7, accent: "red", text: "قربك راحة لقلبي لا تشبه أي شيء." },
  { id: 8, accent: "white", text: "ومهما طال العمر... أحبك أكثر كل يوم." },
];
...
function buildFridge() {
  ...
  var drawerTopY = ((drawerMessages.length - 1) * drawerSpacing) / 2;
